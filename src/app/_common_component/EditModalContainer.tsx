  ...
  return (
    <>
      ...
      <div className="relative">
        <button
          onClick={onClick}
          className="absolute right-0 top-0 z-50 mr-5 mt-5 rounded bg-[#00a5a5] px-4 py-2 text-black opacity-40 shadow hover:bg-[#197777] focus:outline-none focus:ring-2 focus:ring-black"
        >
          Edit
        </button>
      </div>
